...
class ImageClass:
	...
	def get_example_image(self):
		# return specific example image (nice for near edges analysis)
		#	needs to set a particular random seed and load that batch of images
		np.random.seed(60)
		imgs = self.get_2k_random_images()

		return np.copy(imgs[8])
	...
	def get_sky_rafidi_example(self):
		...
		img_filepath = './results/gaudi_example_image.jpg'
