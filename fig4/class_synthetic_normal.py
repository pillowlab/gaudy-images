# class to generate images from generator network (trained on normal images)
#
...
### INTERNAL HELPER FUNCTIONS
	...
	def synthesize_images(self, I, R, M):
		...
		for iimg in range(self.num_cand_images):
			...
			# get initial image
			seed()
			img_synth = I.get_random_natural_images() 
			...
			imgs.append(self.get_image_from_features(I, feature_synth))  # gets image from feature_synth
...
### INIT FUNCTION
	...
	def __init__(self, I, F, R, M, num_rands=250, num_epochs=20, step_size=1e3, lambda_featuresNN=1e0):
			#  num_rands=250, num_epochs=50, step_size=500, lambda_featuresNN=10.
		self.F = F

		# load natural prior model
		filepath_generator_model = './results/saved_models/generator_networks/generator_normal.h5'
